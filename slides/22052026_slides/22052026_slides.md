...
**8 cortical nodes**, each an excitatory + inhibitory population pair (**E** + **I**). Their interaction produces an alpha-range oscillation.

## Free parameter

**`τ_inh`** (inhibitory response time). Larger `τ_inh` → slower rhythm. This is the knob we turn to simulate the alpha slowing.

## Simplifications

- Identical parameters across all 8 nodes
- All-to-all coupling, strength `K_gl`
- No noise
