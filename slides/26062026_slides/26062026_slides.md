...
style: |
  ...
  section.title h1 {
    font-size: 35px; font-weight: 700; color: #0f172a;
    border-bottom: none; border-left: 6px solid #185FA5;
    padding: 6px 0 6px 22px; margin: 0 0 14px 0; line-height: 1.25;
  }
  section.title .subtitle { font-size: 18px; color: #475569; margin: 0 0 26px 28px; }
  section.title .meta { font-size: 13px; color: #64748b; margin: 24px 0 0 28px; letter-spacing: 0.3px; }
---
