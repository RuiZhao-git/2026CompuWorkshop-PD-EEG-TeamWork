...
![w:1080](figures/tau_result.svg)

The fitted **τ_inh** re-expresses the measured slowing in model units. What the model adds is a *validated* fit: parameter recovery is unbiased, and the *+3.25 ms* group difference (Mann-Whitney, p ≈ 0.0002) is 6× the fitting error: a real shift, not an artefact.
