...
- Lower-left top, the repository: numbered scripts, reusable modules, a results folder every run writes into.
  - Lower-left below it, version control: feature branches reviewed and merged into main, fifty commits; main reproduces every result and this deck.
...
<!--
Each of us gives our single biggest take-away. Rui and Jan are filled in; Melissa and Friedrich to be added once they send theirs.
-->
...
<!--
Appendix plus references on one back-matter slide. Top left, the per-subject distributions (box is median and quartiles, dots are subjects); top right, the standardised effect sizes (rank-biserial, 95 percent CI). Bottom, the three sources: Anjum npj 2024 for the data and hypotheses, Wilson and Cowan 1972 for the model, neurolib for the simulation framework.
-->
